(function() {
  ...
  window.Waveform = Waveform = (function() {
    ...
    Waveform.prototype.setDataCroppedCustm = function(data) {
      if (this.interpolate === false) {
        return this.setData(this.expandArray(this.croppeArray(data), this.width));
      } else {
        return this.setData(this.croppeArray(this.interpolateArray(data, this.width)));
      }
    };
    ...
    Waveform.prototype.croppeArray = function(data) {
      ...
      for(i = 0; i < data.length; i++) {
        if(j === 0) {
          ...
          newdata.push(0.06428571428571428);
          this.zerolg++;
          j = 0;
        }
      }
    ...
    Waveform.prototype.dataFromSoundCloudTrack = function(track) {
      ...
      return JSONP.get("/soundcloud/waveform", {
